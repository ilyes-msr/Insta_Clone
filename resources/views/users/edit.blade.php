          ...
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            <div>
              ...
              <div class="mt-1 flex items-center">
                <img src="{{ $user->image }}" class="h-12 w-12 object-cover rounded-full ltr:mr-5 rtl:ml-5 border border-gray-300 mr-5">
                <input class="w-full border border-gray-200 bg-gray-50 block focus:outline-none rounded-xl hidden" name="image" id="file_input" type="file">
                <x-button type="button" onclick="document.getElementById('file_input').click()">
                  {{ __('Change photo') }}
                </x-button>
              </div>
              @error('image')
            ...
            <div>
              <div class="flex items-start">
                ...
                <div class="ltr:ml-3 rtl:mr-3 text-sm ml-3">
